---
title: "Association Between Fundamental Motor Skill Domains and Physical Fitness Components in Children Aged 5 to 11 Years"
...
author:
  - name: Oldemar Mazzardo
    corresponding: false
    orcid: 0000-0001-5325-9815
    affiliations:
      - id: id1
        name: Western Paraná State University - Unioeste
  - name: Bárbara Maria Weis
    affiliations:
    - ref: id1    
  - name: Adelar Aparecido Sampaio
    orcid: 0000-0003-4386-1364
    affiliations:
    - ref: id1    
  - name: Dartel Ferrari de Lima
    orcid: 0000-0002-3633-9458
    affiliations:
    - ref: id1    
  - name: Dayane Cristina de Souza
    orcid: 0000-0003-4552-6500
    affiliations:
    - ref: id1    
  - name: Ovande Furtado Jr
    corresponding: true
    orcid: /0000-0003-3847-6314 
    email: ovandef@csun.edu (818-564-7507)
    affiliations: 
...
author-note:
  ...
  status-changes: 
    ...
    affiliation-change: Adelar Aparecido Sampaio is now at the Federal University of Mato Grosso do Sul.
